...
# 23 Columns (MINUS the ID as the rsyslog event follows a standard PK) -> 
#       THIS IS FOR THE STANDARD TEMPLATE for RSYSLOG (https://www.rsyslog.com/doc/v8-stable/configuration/modules/ompgsql.html)
# id -> integer
# customerid -> bigint
...
class Event(models.Model):
    ...
    def __str__(self):
        return '{}-{}-{}'.format(self.pk, self.receivedat, self.fromhost) 
